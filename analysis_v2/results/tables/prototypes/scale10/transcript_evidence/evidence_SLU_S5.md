...
| Tori Hoehler ↔ Tori Hoeler | 4 | Tori Hoeler (`synthesizes_contributions`) | “fun dynamic that I see emerging here right which is on the observational side kind of looking at what's…” | Tori Hoehler: “some of that to me just to try to carry this forward gets to is kind of emblematic of a bigger issue how do…” | explanation named the person |
...
| Amanda Stockton ↔ Jay Forsythe | 2 | Jay Forsythe (`extends_existing_idea`) | “I can almost imagine something similar but just on a chemical level where you dope in different organics that…” | Amanda Stockton: “get like a massive database of everything that everyone has done in the literature so far and then we could…” | explanation named the person |
