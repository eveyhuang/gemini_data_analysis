...
def main():
    ...
    for filename in os.listdir(data_dir):
        if filename.endswith('.json') and filename != f'{dataset}_outcome.json' and filename != f'{dataset}_session_outcomes.json' and filename != f'{dataset}_person_to_team.json':
